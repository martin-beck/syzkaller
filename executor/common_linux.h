...
enum UNIQUE_VAR(csb_aio_op) {
	UNIQUE_VAR(csb_aio_setup),
	UNIQUE_VAR(csb_aio_getevents),
	UNIQUE_VAR(csb_aio_pgetevents),
	UNIQUE_VAR(csb_aio_destroy),
	UNIQUE_VAR(csb_aio_submit),
	UNIQUE_VAR(csb_aio_cancel),
};
...
static long UNIQUE_FUNC(csb_aio_lifecycle)(enum UNIQUE_VAR(csb_aio_op) op)
{
	aio_context_t ctx = 0;
	...
	if (op == UNIQUE_VAR(csb_aio_getevents))
		ret = syscall(__NR_io_getevents, ctx, 0, 1, &event, &timeout);
#if defined(__NR_io_pgetevents)
	else if (op == UNIQUE_VAR(csb_aio_pgetevents))
		ret = syscall(__NR_io_pgetevents, ctx, 0, 1, &event, &timeout, 0);
#endif

	else if (op == UNIQUE_VAR(csb_aio_submit) || op == UNIQUE_VAR(csb_aio_cancel)) {
		char byte = 0;
		struct iocb cb;
		...
		if (op == UNIQUE_VAR(csb_aio_cancel))
...
{
	return UNIQUE_FUNC(csb_aio_lifecycle)(UNIQUE_VAR(csb_aio_setup));
}
static long UNIQUE_FUNC(syz_csb_io_getevents)(void)
{
	return UNIQUE_FUNC(csb_aio_lifecycle)(UNIQUE_VAR(csb_aio_getevents));
}
static long UNIQUE_FUNC(syz_csb_io_pgetevents)(void)
{
	return UNIQUE_FUNC(csb_aio_lifecycle)(UNIQUE_VAR(csb_aio_pgetevents));
}
static long UNIQUE_FUNC(syz_csb_io_destroy)(void)
{
	return UNIQUE_FUNC(csb_aio_lifecycle)(UNIQUE_VAR(csb_aio_destroy));
}
static long UNIQUE_FUNC(syz_csb_io_submit)(void)
{
	return UNIQUE_FUNC(csb_aio_lifecycle)(UNIQUE_VAR(csb_aio_submit));
}
static long UNIQUE_FUNC(syz_csb_io_cancel)(void)
{
	return UNIQUE_FUNC(csb_aio_lifecycle)(UNIQUE_VAR(csb_aio_cancel));
}
#endif
...
{
	return UNIQUE_FUNC(csb_exit_lifecycle)(false);
}
static long UNIQUE_FUNC(syz_csb_exit_group)(void)
{
	return UNIQUE_FUNC(csb_exit_lifecycle)(true);
}
#endif
...
static long UNIQUE_FUNC(syz_reapply_affinity)(void)
{
	...
	static _Thread_local cpu_set_t mask;
