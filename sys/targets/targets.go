...
var oses = map[string]osCommon{
	Linux: {
		...
		PseudoSyscallDeps: map[string][]string{
			...
			"syz_csb_execve":        {"execve", "exit", "wait4"},
			"syz_csb_execveat":      {"execveat", "exit", "wait4"},
			"syz_csb_fexecve":       {"execveat", "exit", "openat", "wait4"},
			"syz_csb_io_setup":      {"io_setup", "io_destroy"},
			"syz_csb_io_getevents":  {"io_setup", "io_getevents", "io_destroy"},
			"syz_csb_io_pgetevents": {"io_setup", "io_pgetevents", "io_destroy"},
			"syz_csb_io_destroy":    {"io_setup", "io_destroy"},
			"syz_csb_io_submit":     {"io_setup", "io_submit", "io_getevents", "io_destroy"},
			"syz_csb_io_cancel":     {"io_setup", "io_submit", "io_cancel", "io_getevents", "io_destroy"},
